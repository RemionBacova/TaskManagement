...
namespace WebApiTaskManagement.Repository.Abstract.Base.EntitiesRepository
{
    public abstract class sp_tbl_TABLE_INFO_Repository
    {
        ...
        public async Task<IEnumerable<tbl_TABLE_INFO_Model>> SelectAllActiveRecByUID(string tableName, string UID)
        {
            using (IDbConnection db = new SqlConnection(_constring))
            {
        ...
        public async Task<IEnumerable<tbl_TABLE_INFO_Model>> SelectAllActiveRecBySup(string tableName, string? uid_sup, string? active, string? nomination, string? description)
        {
            using (IDbConnection db = new SqlConnection(_constring))
            {
