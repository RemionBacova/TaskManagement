...
namespace WebApiTaskManagement.Controllers.Client_Controllers
{
    ...
    [ApiController]
    public class tbl_CLIENTSController : Abstract.Base.tbl_TABLE_ControllerAbstract
    {
        

       
        public tbl_CLIENTSController(sp_tbl_TABLE_Repository repository) : base(repository, "CLIENTS") 
        { }
