...
namespace WebApiTaskManagement.Controllers.Employees_Controllers
{
    ...
    [ApiController]
    public class tbl_EMPLOYEESController : Abstract.Base.tbl_TABLE_ControllerAbstract
    {
        

       
        public tbl_EMPLOYEESController(sp_tbl_TABLE_Repository repository) : base(repository, "EMPLOYEES") 
        { }
